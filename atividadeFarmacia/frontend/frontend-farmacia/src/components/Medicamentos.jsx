...
import { mostarMedicamentos, patchMedicamento, postMedicamento } from "../services/medicamento";
...
export default function Medicamentos() {
    ...
    const carregarMedicamentos = async () => {
        ...
        try {
            ...
            const listamedicamentos = await mostarMedicamentos()
    ...
    const salvarMedicamento = async (e) => {
        ...
        try {
            ...
            if (!editando) {
                ...
                const response = await postMedicamento(form)

                alert(response.data.message);

            } else {

                const response = await patchMedicamento(idEditando, form)
